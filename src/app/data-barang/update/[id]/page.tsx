...
const Page = () => {
    ...
    const handleAddData = async () => {
        ...
        try {
            ...
            dataBarang.append('id', addData.id);
            ...
            if (addData.imageUpdate) {
                dataBarang.append('image', addData.imageUpdate);
            }
            ...
            if (response.status === 200) {
                showToast('success', "Berhasil Mengedit Data");
                fetchData();
            }
        } catch (error) {
            console.log(error);
                            ...
                            <div className="w-full h-full flex flex-col gap-3">
                                ...
                                {addData.imageUpdate ? (
                                    <div className="h-[200px] w-full shadow center-flex" >
                                        <Image 
                                            src={URL.createObjectURL(addData.imageUpdate)}
                                            alt="Image add data"
                                            width={100}
                                            height={100}
                                        />
